...
function App() {
  ...
  return (
    ...
    <div className="hero grid md:grid-cols-2 items-center pt-10 xl:gap-0 gap-6 grid-cols-1">
      <div className="animate__animated animate__fadeInUp animate__delay-3s">
        <div className="flex items-center gap-3 mb-6 bg-zinc-800 w-fit p-4 rounded-2xl">
          <img src="/bimo.jpeg" className="w-10 rounded-md" loading="lazy"/>
          <q>kota yang indah, lahir dari bogor.🤣</q>
        </div>
        <h1 className="text-5xl/tight font-bold mb-6">Hi, saya bimo saputro</h1>
        <p className="text-base/loose mb-6 opacity-50">
          Saya adalah seseorang yang memiliki minat besar di bidang futsal. Bagi saya, futsal bukan sekadar olahraga, tetapi juga cara untuk melatih disiplin, kerja sama tim, komunikasi, dan kemampuan mengambil keputusan dengan cepat di bawah tekanan. Melalui setiap pertandingan, saya belajar pentingnya tanggung jawab, sportivitas, dan semangat pantang menyerah.
        </p>
        <div className="flex items-center sm:gap-4 gap-2">
          <a href="#" className="bg-violet-700 p-4 rounded-2xl hover:bg-violet-600">Download CV <i className="ri-arrow-down-line"></i>
          </a>
          <a href="#proyek" className="bg-zinc-700 p-4 rounded-2xl hover:bg-zinc-600">Lihat Proyek <i className="ri-arrow-down-line"></i></a>
        </div>
      </div>
      <img src="/bimo.jpeg"  className="w-[500px] md:ml-auto  animate__animated animate__fadeInUp animate__delay-4s" loading="lazy"/>
    </div>
    ...
    <div className="tentang mt-32 py-10" id="tentang">
      <div className="xl:w-2/3 lg:w-3/4 w-full mx-auto p-7 bg-zinc-800 rounded-lg" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
        ...
        <p className="text-base/loose mb-10">
          Hi, perkenalkan saya bimo saputro,seseorang yang memiliki minat besar di bidang futsal. Bagi saya, futsal bukan sekadar olahraga, tetapi juga cara untuk melatih disiplin, kerja sama tim, komunikasi, dan kemampuan mengambil keputusan dengan cepat di bawah tekanan. Melalui setiap pertandingan, saya belajar pentingnya tanggung jawab, sportivitas, dan semangat pantang menyerah.
        </p>
    ...
    <div className="proyek mt-32 py-10" id="proyek">
      ...
      <p className="text-base/loose text-center opacity-50"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" data-aos-once="true" >Berikut ini beberapa proyek yang telah kita buat.</p>
    ...
    <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
      ...
      <form action="https://formsubmit.co/bimosaputro1103@gmail.com" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off"  data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500" data-aos-once="true">
